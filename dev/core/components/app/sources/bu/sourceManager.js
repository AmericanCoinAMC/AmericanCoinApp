...
app.component('sourceManager', {
    ...
    controller: [
        '$rootScope','$scope', '$timeout', 'Dialog', '$state',
        function($rootScope, $scope, $timeout, Dialog, $state){
            var self = this;
            ...
            * */
            ...
            $scope.configSource = function(source){
                $state.go('app.sourceManager.configuration', {source: source});
            }
