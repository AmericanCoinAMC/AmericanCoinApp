            ...
            return {
                ...
                subscribe: function(){
                    ...
                    $rootScope.$on('$stateChangeStart',
                        angular.bind(this, function(event, toState, toParams, fromState, fromParams, options) {
                            this.deactivate();
                        }));
                 ...
                 * Array Handlers
                 * */
                addItem: function(snapshot){
                    if(!this.itemExists(snapshot)){
                        itemsArray.push(objectBuilder.buildFromSnapshot(snapshot));
                        displayedItems += 1;
                    }
                },
