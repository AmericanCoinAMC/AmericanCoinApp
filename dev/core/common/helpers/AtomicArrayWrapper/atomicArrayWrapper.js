...
app.directive('atomicArrayWrapper',
                    ...
                    if(scope.config != undefined){
                        ...
                        scope.getWrapperUrl = function(){
                            ...
                            if(scope.config.wrapper == 'infiniteScroll'){
                                wrapperUrl = '/core/common/helpers/AtomicArrayWrapper/infiniteScrollWrapper.html';
                            }else if(scope.config.wrapper == 'loadMore'){
                                wrapperUrl = '/core/common/helpers/AtomicArrayWrapper/loadMoreWrapper.html';
                            }
                            return wrapperUrl;
                        };
